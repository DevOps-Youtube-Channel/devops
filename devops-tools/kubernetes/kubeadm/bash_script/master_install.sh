...
echo -e "${YELLOW}[*]Join the worker nodes to the master with kubeadm join${NC}"
echo -e "${LIGHT_GREEN}-----------------------------------------------------------------------------------------------------------------${NC}"
echo -e "${YELLOW}[*]Install and configure flannel on k8s-master${NC}"
echo -e "${LIGHT_GREEN}-----------------------------------------------------------------------------------------------------------------${NC}"
echo -e "${YELLOW}[*]kubectl apply -f https://github.com/flannel-io/flannel/releases/latest/download/kube-flannel.yml ${NC}"
echo -e "${LIGHT_GREEN}-----------------------------------------------------------------------------------------------------------------${NC}"
